...
class TextClassificationProcessor(Processor):
    ...
    def _dict_to_samples(self, dictionary: dict, **kwargs) -> [Sample]:
        ...
        tokenized = tokenize_with_metadata(str(text), self.tokenizer)
...
class SquadProcessor(Processor):
    ...
    def _dict_to_samples(self, dictionary: dict, **kwargs) -> [Sample]:
        n_special_tokens = self.tokenizer.num_special_tokens_to_add(pair=True)#num_added_tokens(pair=True)
